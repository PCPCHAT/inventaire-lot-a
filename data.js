const inventory = {
  "Sac POM": {
    ...
    { name: "Stop-vide ou raccord biconique", expected: 2 }
  ],
  "Poche N°4": [
    { name: "MHC Adulte", expected: 4 },
    { name: "MMC Adulte", expected: 4 },
    { name: "Lunette à oxygène", expected: 3 }
  ],
  "Poche N°5": [
    { name: "HC Pédiatrique", expected: 3 },
    { name: "MMC Pédiatrique", expected: 3 }
  ],
  "Poche N°6": [
    { name: "Couverture de survie", expected: 15 },
